package com.example.dfh.planethunder.Plane;
...
import com.example.dfh.planethunder.Bullet.Bullet;
...
import com.example.dfh.planethunder.Interface.IMyPlane;
...
public class MyPlane extends GameObject implements IMyPlane {
    ...
    public void setScreenWH(float screen_width, float screen_height) {
        ...
        object_y = screen_height - object_height-screen_height/10;
        middle_x = object_x + object_width / 2;
        middle_y = object_y + object_height / 2;
    }
  public  void setScreenWH1(float screen_width, float screen_height){
    middle_x = object_x + object_width / 2;
    middle_y = object_y + object_height / 2;
}
    @Override
